...
class Controller(object):
    ...
    def index(self, request, template_id, path):
        """It obtains all the services/applications associated to
           ...
           :param template_id: The template id with contains the services
        ...
        try:
            ...
            msg = 'The template does not exist'
            LOG.exception(msg)
    ...
    def show(self, request, template_id, path):
        ...
        :param request: The operation request.
        :param template_id: the template ID where the service belongs to.
